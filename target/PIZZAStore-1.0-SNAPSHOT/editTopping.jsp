<%-- 
    Document   : editTopping
    Created on : Dec 24, 2024, 5:16:36 PM
    Author     : suraj
--%>
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h2><i class="fas fa-c mr-3"></i>Edit Topping</h2>
    ...
    <form action="ToppingController" method="post">
        ...
        <input type="text" class="form-control" id="toppingName" name="toppingName" value="${topping.toppingName}" required><br>

        <label for="toppingPrice">Topping Price:</label>
        <input type="number" class="form-control" id="toppingPrice" name="toppingPrice" value="${topping.toppingPrice}" step="0.01" required><br>

        <button type="submit" class="btn btn-primary"><i class="fas fa-p mr-2"></i>Update topping</button>
