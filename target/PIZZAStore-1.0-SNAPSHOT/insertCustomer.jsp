<%-- 
    ...
    Created on : Dec 22, 2024, 10:54:11 AM
    Author     : suraj
--%>
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h2><i class="fas fa-c mr-3"></i>Add New Customer</h2>
        ...
        <form action="CustomerController?action=add" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="tel" class="form-control" id="cus_Phone" name="cus_Phone" required>
            </div>
             <div class="form-group">
                <label for="loyaltyPoint">Loyalty Points:</label>
                <input type="number" class="form-control" id="loyaltyPoint" name="loyaltyPoint" min="0" required>
            </div>
             <div class="form-group">
                <label for="cusPassword">Password:</label>
                <input type="password" class="form-control" id="cus_Password" name="cus_Password" required>
            </div>
             <button type="submit" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Add Customer</button>
