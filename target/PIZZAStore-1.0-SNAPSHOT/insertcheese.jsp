<%-- 
    Document   : insertcheese
    Created on : Dec 24, 2024, 4:36:24 PM
    Author     : suraj
--%>
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h2><i class="fas fa-cheese mr-3"></i>Add New Cheese</h2>
        <form action="CheeseController" method="post">
            <input type="hidden" name="action" value="add">
            <div class="form-group">
                <label for="cheeseName">Cheese Name</label>
                <input type="text" class="form-control" id="cheeseName" name="cheeseName" required>
            </div>
            <div class="form-group">
                <label for="cheesePrice">Cheese Price</label>
                <input type="number" step="0.01" class="form-control" id="cheesePrice" name="cheesePrice" required>
            </div>
            <button type="submit" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Add Cheese</button>
        </form>
        <a href="CheeseController?action=viewAll" class="btn btn-secondary mt-3"><i class="fas fa-arrow-left mr-2"></i>Back to Cheese List</a>
    </div>
