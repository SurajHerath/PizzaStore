<%-- 
    Document   : InsertExtraTopping
    Created on : Dec 23, 2024, 7:10:17 PM
    Author     : suraj
--%>
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h2><i class="fas fa-cheese mr-3"></i>Insert Extra Topping</h2>

    <form action="ExtraToppingController" method="POST">
  <input type="hidden" name="action" value="insert">
  
  <div class="form-group">
        <label for="name">Topping Name:</label>
        <input type="text" class="form-control"id="extraTopping_Name" name="extraTopping_Name" required>
 </div>       
        <div class="form-group">
        <label for="quantity">Quantity (grams):</label>
        <input type="text" class="form-control"id="quantity_Grams" name="quantity_Grams" required>
  </div>      
        <div class="form-group">
        <label for="price">Price):</label>
        <input type="text" class="form-control"id="topping_Price" name="topping_Price" required>
  </div>
  <button type="submit" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Add Extra Topping</button>  
</form>

    <br>
    <a href="ExtraToppingController?action=list">Back to Topping List</a>
</div>
