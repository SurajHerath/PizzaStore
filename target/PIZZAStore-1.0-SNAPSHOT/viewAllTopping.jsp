<%-- 
    Document   : viewAllTopping
    Created on : Dec 24, 2024, 5:17:02 PM
    Author     : suraj
--%>
...
<head>
    ...
    <title>All Topping - Pizza Store</title>
...
<body>
    ...
    <div class="container">
        <h2 class="mt-5">List of Toppings</h2>
        <a href="insertTopping.jsp" class="btn btn-success mb-3">Add New Topping</a>
        ...
        <tbody>
            <c:forEach var="topping" items="${toppingList}">
                <tr>
                    ...
                    <td>
                        <a href="ToppingController?action=edit&toppingID=${topping.toppingID}" class="btn btn-warning btn-sm">Edit</a> |
                        <a href="ToppingController?action=delete&toppingID=${topping.toppingID}" class="btn btn-danger btn-sm"onclick="return confirm('Are you sure you want to delete this topping?');">Delete</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
    ...
    <br>
    <a href="insertTopping.jsp">Add New Topping</a>
