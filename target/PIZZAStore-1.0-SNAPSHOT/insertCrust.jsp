<%-- 
    Document   : insertCrust
    Created on : Dec 24, 2024, 4:19:42 PM
    Author     : suraj
--%>
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h2><i class="fas fa-cheese mr-3"></i>Insert New Crust</h2>
    ...
    <form action="CrustController" method="post">
        ...
        <input type="text" class="form-control" id="crustName" name="crustName" required />
       
        </div>
        <div class="form-group">
        <label for="crustPrice">Crust Price:</label>
        <input type="number" class="form-control" id="crustPrice" name="crustPrice" step="0.01" required />
       
        </div>
        <button type="submit" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Add Crust</button>
