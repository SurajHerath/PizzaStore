<%-- 
    Document   : viewAllOrderState
    Created on : Dec 25, 2024, 3:27:47 PM
    Author     : suraj
--%>
...
<%
    List<model.OrderState> orderStates = (List<model.OrderState>) request.getAttribute("orderStates");
%>
...
<head>
    ...
    <title>All Orders - Pizza Store</title>
...
<body>
    ...
    <div class="container">
        <h2 class="mt-5">List of Order States</h2>
    ...
    <div class="container">
            ...
            <tbody>
                <c:forEach var="orderState" items="${orderStates}">
                    <tr>
                        <td>${orderState.status_ID}</td>
                        <td>${orderState.status}</td>
                        <td>${orderState.order_ID}</td>
                        <td>
                            <a href="editOrderState.jsp?status_ID=${orderState.status_ID}&status=${orderState.status}&order_ID=${orderState.order_ID}" 
                               class="btn btn-warning btn-sm">Edit</a>
                            <a href="OrderStatesController?action=delete&status_ID=${orderState.status_ID}" 
                               class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this order state?');">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
