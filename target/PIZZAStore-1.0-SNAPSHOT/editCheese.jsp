<%-- 
    Document   : editCheese
    Created on : Dec 24, 2024, 4:36:54 PM
    Author     : suraj
--%>
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h2><i class="fas fa-che mr-3"></i>Edit Cheese</h2>
        
        <form action="CheeseController" method="post">
            <input type="hidden" name="action" value="update">
            <input type="hidden" name="cheeseID" value="${cheese.cheeseID}">
            <div class="form-group">
                <label for="cheeseName">Cheese Name</label>
                <input type="text" class="form-control" class="form-control" id="cheeseName" name="cheeseName" value="${cheese.cheeseName}" required>
            </div>
            <div class="form-group">
                <label for="cheesePrice">Cheese Price</label>
                <input type="number" step="0.01" class="form-control" class="form-control" id="cheesePrice" name="cheesePrice" value="${cheese.cheesePrice}" required>
            </div>
            <button type="submit" class="btn btn-primary">Update Cheese</button>
        </form>
        <a href="CheeseController?action=viewAll" class="btn btn-secondary mt-3">Back to Cheese List</a>
    </div>
