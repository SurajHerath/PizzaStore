<%-- 
    ...
    Created on : Dec 19, 2024, 4:40:58 PM
    Author     : suraj
--%>
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h2><i class="fas fa-ch mr-3"></i>Update Pizza</h2>

        <form action="${pageContext.request.contextPath}/PizzaController?action=update" method="POST" class="form">
            
            <input type="hidden" name="pizza_ID" value="${pizza.pizza_ID}">
            <div class="form-group">
                <label for="pizza_Name">Pizza Name:</label>
                <input type="text" class="form-control" id="pizza_Name" name="pizza_Name" value="${pizza.pizza_Name}" required>
                
            </div>
            <div class="form-group">
                <label for="crust">Crust:</label>
                <input type="text" class="form-control" id="crust" name="crust" value="${pizza.crust}" required>
            </div>
            <div class="form-group">
                <label for="sauce">Sauce:</label>
                <input type="text" class="form-control" id="sauce" name="sauce" value="${pizza.sauce}" required>
            </div>
            <div class="form-group">
                <label for="cheese">Cheese:</label>
                <input type="text" class="form-control" id="cheese" name="cheese" value="${pizza.cheese}" required>
            </div>
