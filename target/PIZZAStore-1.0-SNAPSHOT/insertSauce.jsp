<%-- 
    Document   : insertSauce
    Created on : Dec 24, 2024, 5:00:21 PM
    Author     : suraj
--%>
...
<html lang="en">
    ...
    <div class="container">
        ...
        <!-- Main Content -->
        <div class="container">
            <h2><i class="fas fa-t mr-3"></i>Add New Sauce</h2>
        <form action="SauceController" method="POST">
            <input type="hidden" name="action" value="add">
            
            <div class="form-group">
                <label for="sauceName">Sauce Name:</label>
                <input type="text" class="form-control" id="sauceName" name="sauceName" required>
            </div>
            
            <div class="form-group">
                <label for="saucePrice">Sauce Price:</label>
                <input type="number" class="form-control" id="saucePrice" name="saucePrice" step="0.01" required>
            </div>
