<%-- 
    Document   : editSauce
    Created on : Dec 24, 2024, 5:00:44 PM
    Author     : suraj
--%>
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h2><i class="fas fa-che mr-3"></i>Edit Sauce</h2>
        
        
        
        
        <form action="SauceController" method="POST">
            <input type="hidden" name="action" value="update">
            <input type="hidden" name="sauceID" value="${sauce.sauceID}">
            
            <div class="form-group">
                <label for="sauceName">Sauce Name:</label>
                <input type="text" class="form-control" class="form-control" id="sauceName" name="sauceName" value="${sauce.sauceName}" required>
            </div>
            
            <div class="form-group">
                <label for="saucePrice">Sauce Price:</label>
                <input type="number" class="form-control" class="form-control" id="saucePrice" name="saucePrice" value="${sauce.saucePrice}" step="0.01" required>
            </div>
            
            
            <button type="submit" class="btn btn-primary">Update Sauce</button>
            <a href="SauceController?action=viewAll" class="btn btn-secondary">Back to List</a>
        </form>
    </div>
