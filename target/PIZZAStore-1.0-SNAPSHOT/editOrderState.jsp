<%-- 
    Document   : editOrderState
    Created on : Dec 25, 2024, 3:27:18 PM
    Author     : suraj
--%>
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h2><i class="fas fa-ch mr-3"></i>Edit order State</h2>
        

        <form action="OrderStatesController?action=update" method="post">
            <input type="hidden" name="status_ID" value="<%= status_ID %>">
            <div class="mb-3">
                <label for="status" class="form-label">Status</label>
                <input type="text" class="form-control" class="form-control" id="status" name="status" value="<%= status %>" required>
            </div>
            <div class="mb-3">
                <label for="order_ID" class="form-label">Order ID</label>
                <input type="text" class="form-control" class="form-control" id="order_ID" name="order_ID" value="<%= order_ID %>" required>
            </div>
            <button type="submit" class="btn btn-primary">Update</button>
        </form>
        <a href="viewAllOrderState.jsp" class="btn btn-secondary mt-3">Cancel</a>
    </div>
