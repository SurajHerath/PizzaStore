<%-- 
    ...
    Created on : Dec 22, 2024, 3:11:49 PM
    Author     : suraj
--%>
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h2><i class="fas fa-cheese mr-3"></i>All Customers</h2>
       
       
                <form id="searchForm" method="GET" action="CustomerController">
                    <input type="hidden" name="action" value="search" />
                    <div class="input-group mb-4">
                        <input type="text" id="searchInput" name="query" class="form-control" placeholder="Search by Customer Name or ID" autocomplete="off" required>
                 ...
                 <table class="table">
                    ...
                    <tbody>
                        <%
                            ...
                            List<Customer> customersToDisplay = (searchResults != null && !searchResults.isEmpty()) ? searchResults : (List<Customer>) request.getAttribute("customers");

                            if (customersToDisplay != null && !customersToDisplay.isEmpty()) {
                        ...
                        <tr>
                            ...
                            <td><%= customer.getCus_Phone() %></td>
                            <td><%= customer.getLoyaltyPoint() %></td>
                            <td>
                                <a href="CustomerController?action=edit&cus_ID=<%= customer.getCus_ID() %>" class="btn btn-warning">Edit</a>
                                <a href="CustomerController?action=delete&cus_ID=<%= customer.getCus_ID() %>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this customer?');">Delete</a>
                            </td>
                        </tr>
                        <%
                                }
