<%-- 
    Document   : viewAllCheeses
    Created on : Dec 24, 2024, 4:37:15 PM
    Author     : suraj
--%>
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h2><i class="fas fa-cheese mr-3"></i>All Cheeses</h2>
        <a href="insertcheese.jsp" class="btn-add"><i class="fas fa-plus mr-2"></i>Add New Cheese</a>
        <table class="table">
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                <c:forEach var="cheese" items="${cheeseList}">
                    <tr>
                        <td>${cheese.cheeseID}</td>
                        <td>${cheese.cheeseName}</td>
                        <td>$${cheese.cheesePrice}</td>
                        <td>
                            <a href="CheeseController?action=edit&cheeseID=${cheese.cheeseID}" class="btn-edit"><i class="fas fa-edit mr-1"></i>Edit</a>
                            <a href="CheeseController?action=delete&cheeseID=${cheese.cheeseID}" class="btn-delete" onclick="return confirm('Are you sure you want to delete this cheese?')"><i class="fas fa-trash-alt mr-1"></i>Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
