<%-- 
    Document   : insertTopping
    Created on : Dec 24, 2024, 5:16:04 PM
    Author     : suraj
--%>
...
<html lang="en">
    ...
    <div class="container">
        ...
        <!-- Main Content -->
        <div class="container">
            <h2><i class="fas fa-t mr-3"></i>Add New Topping</h2>

            <form action="ToppingController" method="post">
                <input type="hidden" name="action" value="add">
                
                <div class="form-group">
                    <label for="toppingName">Topping Name:</label>
                    <input type="text" class="form-control" id="toppingName" name="toppingName" required><br>
                </div>
                <div class="form-group">
                    <label for="toppingPrice">Topping Price:</label>
                    <input type="number" class="form-control" id="toppingPrice" name="toppingPrice" step="0.01" required><br>
                </div>
                <button type="submit" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Add Topping</button>
            </form>


            <br>
            <a href="ToppingController?action=viewAll" class="btn btn-secondary mt-3"><i class="fas fa-arrow-left mr-2"></i>Back to Toppings List</a>
            </div>
