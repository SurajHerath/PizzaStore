...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h2><i class="fas fa-cheese mr-3"></i>Orders for Customer ID: <%= request.getAttribute("customerID") %></h2>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="OrderController?action=viewOrderDetails&orderID=<%= order.getOrderID() %>" class="btn btn-primary btn-sm">View Details</a>
                    </td>
                </tr>
                <% 
                        }
