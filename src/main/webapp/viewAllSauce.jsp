<%-- 
    Document   : viewAllSauce
    Created on : Dec 24, 2024, 5:01:12 PM
    Author     : suraj
--%>
...
<head>
    ...
    <title>All Sauce - Pizza Store</title>
...
<body>
    ...
    <div class="container">
        <h2 class="mt-5">List of Sauces</h2>
        <a href="insertSauce.jsp" class="btn btn-success mb-3">Add New Sauce</a>
        <table class="table table-bordered">
            ...
            <tbody>
                <% 
                    List<Sauce> sauces = (List<Sauce>) request.getAttribute("sauceList");
                    for (Sauce sauce : sauces) { 
                %>
                    <tr>
                        <td><%= sauce.getSauceID() %></td>
                        <td><%= sauce.getSauceName() %></td>
                        <td><%= sauce.getSaucePrice() %></td>
                        <td>
                            <a href="SauceController?action=edit&sauceID=<%= sauce.getSauceID() %>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="SauceController?action=delete&sauceID=<%= sauce.getSauceID() %>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this sauce?')">Delete</a>
                        </td>
                    </tr>
                <% } %>
            </tbody>
